...
// NonRuntimeFiles returns the modified and untracked files that are NOT Gas Town
// runtime artifacts. These are the files that represent actual developer work
// and should be committed before completing.
